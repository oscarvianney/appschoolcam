...
from classroom.views import Categories, CategoryCourses, NewCourse, Enroll, DeleteCourse, \
	EditCourse, MyCourses, CourseDetail, Submissions, StudentSubmissions, GradeSubmission, get_classes, get_matieres

from module.views import NewModule, CourseModules
from page.views import NewPageModule, PageDetail, MarkPageAsDone, EditPage
...
urlpatterns = [
	...
	path('matieres/<class_slug>', get_matieres, name='matieres'),
	path('categories/<matiere_slug>', Categories, name='categories'),
	path('category/<cat_slug>', CategoryCourses, name='category-courses'),
	...
	path('<course_id>/modules/<module_id>/pages/<page_id>/editpage', EditPage, name='edit-page'),
	#Quizzes
