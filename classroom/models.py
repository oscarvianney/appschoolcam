...
class Classes(models.Model):
	...
	def get_absolute_url(self):
		return reverse('classese', arg=[self.slug])
...
class Matiere(models.Model):
	...
	icon = models.CharField(max_length=100, verbose_name='Icon', default='article')
	slug = models.SlugField(unique=True)
	classes = models.ForeignKey(Classes, on_delete=models.CASCADE, null=True, related_name="matieres")

	def get_absolute_url(self):
		return reverse('matieres', arg=[self.slug])
...
class Category(models.Model):
	...
	icon = models.CharField(max_length=100, verbose_name='Icon', default='article')
	slug = models.SlugField(unique=True)
	matiere = models.ForeignKey(Matiere, on_delete=models.CASCADE, null=True, related_name="modules")
